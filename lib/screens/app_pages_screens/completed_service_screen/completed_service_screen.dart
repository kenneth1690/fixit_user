        ...
        builder: (context1, value, child) {
          return PopScope(
            ...
            child: StatefulWrapper(
                ...
                child: Scaffold(
                    appBar: AppBarCommon(
                      title: appFonts.completedBooking, onTap: () {
                      value.booking = null;
                      value.isDownloading = false;
                      value.progress = "";
                      value.notifyListeners();
                              ...
                              child: Container(
                                ...
                                child: value.booking!.bookingStatus!.slug !=
                                    ...
                                    iconOne: SvgPicture.asset(
                                        eSvgAssets.download,colorFilter: ColorFilter.mode(appColor(context).primary, BlendMode.srcIn)),
                                    ...
                                    isRateComplete: isServiceRate(value
                                        .booking!.service!.reviews!),
                                    applyTap: () =>
                                        route.pushNamed(
                                            context, routeName.rateApp, arg: {
                                          "isServiceRate": true,
                                          "serviceId":
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(
                                    AppRadius.r8),
                                color: appColor(context).darkText.withOpacity(
                                    0.2),
                                boxShadow: [
                                  BoxShadow(
